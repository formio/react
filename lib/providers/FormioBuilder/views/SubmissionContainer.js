  ...
  return function (_ReduxView) {
    ...
    function _class2() {
      ...
      return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = _class2.__proto__ || Object.getPrototypeOf(_class2)).call.apply(_ref, [this].concat(args))), _this), _this.container = function (_ref2) {
        ...
        return _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                _reactRouter.Link,
                { to: builder.options.base + '/form/' + params[builder.key + 'Id'] + '/submission/' + params['submissionId'] },
                'View'
              )
            ),
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                _reactRouter.Link,
                { to: builder.options.base + '/form/' + params[builder.key + 'Id'] + '/submission/' + params['submissionId'] + '/edit' },
                'Edit'
              )
            ),
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                _reactRouter.Link,
                { to: builder.options.base + '/form/' + params[builder.key + 'Id'] + '/submission/' + params['submissionId'] + '/delete' },
                'Delete'
              )
            )
          )
        ...
        dispatch(_actions.SubmissionActions.fetch(builder.key, params['submissionId'], params[builder.key + 'Id']));
