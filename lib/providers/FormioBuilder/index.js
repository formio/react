...
var _class = function () {
  function _class(name, appUrl) {
    ...
    this.SubmissionContainer = _builder.SubmissionContainer;
    this.SubmissionView = _builder.SubmissionView;
    this.SubmissionEdit = _builder.SubmissionEdit;
    ...
    var reducer = this.getReducers(this.key, this.appUrl);
    (0, _reduxInjector.injectReducer)(['formio', this.key], reducer);
    (0, _factories.addReducer)(this.key, reducer);
  ...
  _createClass(_class, [{
    ...
    value: function getRoutes() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_reactRouter.Match, { pattern: this.options.base + '/form/:' + this.key + 'Id/submission/:submissionId', component: this.SubmissionContainer(this) }),
        _react2.default.createElement(_reactRouter.Match, { pattern: this.options.base + '/form/:' + this.key + 'Id/submission/:submissionId', exactly: true, component: this.SubmissionView(this) }),
        _react2.default.createElement(_reactRouter.Match, { pattern: this.options.base + '/form/:' + this.key + 'Id/submission/:submissionId/edit', exactly: true, component: this.SubmissionEdit(this) }),
