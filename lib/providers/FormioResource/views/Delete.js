...
exports.default = function (resource) {
  return function (_ReduxView) {
    ...
    function _class2() {
      ...
      }, _this.mapDispatchToProps = function (dispatch, _ref4) {
        var params = _ref4.params;

        return {
          onYes: function onYes() {
            _actions.SubmissionActions.delete(resource.name, params[resource.name + 'Id']).then(function () {
              dispatch(_actions.Navigate.to(resource.basePath()));
            }).catch(function (error) {
              dispatch(_actions2.AlertActions.add('Error deleting submission ' + error));
              dispatch(_actions.Navigate.to(resource.basePath()));
            });
          },
          onNo: function onNo() {
...
var _actions2 = require('../../FormioAlerts/actions');
