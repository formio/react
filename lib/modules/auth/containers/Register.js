...
var RegisterView = function (_FormioView) {
  _inherits(RegisterView, _FormioView);
  ...
  function RegisterView() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = RegisterView.__proto__ || Object.getPrototypeOf(RegisterView)).call.apply(_ref, [this].concat(args))), _this), _this.component = function (props) {
      return _react2.default.createElement(_Form2.default, props);
    }, _this.mapStateToProps = function (state, ownProps) {
      return {
        src: _this.formio.config.projectUrl + '/' + _this.formio.auth.config.register.form
      };
