...
var indexForms = exports.indexForms = function indexForms(name) {
  ...
  return function (dispatch, getState) {
    ...
    var formio = new _Formio2.default((projectUrl || _Formio2.default.getProjectUrl()) + '/form');
    ...
    return formio.loadForms({ params: requestParams }, options).then(function (result) {
      var ignoredResult = [];
