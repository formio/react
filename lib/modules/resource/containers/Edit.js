...
exports.default = function (config) {
  return function (_FormioView) {
    ...
    function Edit() {
      ...
      return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Edit.__proto__ || Object.getPrototypeOf(Edit)).call.apply(_ref, [this].concat(args))), _this), _this.component = function (props) {
