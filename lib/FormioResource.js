...
var _FormioConfirm = require('./partials/FormioConfirm');
...
var _initialiseProps = function _initialiseProps() {
        ...
        return _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                _reactRouter.Link,
                { to: _this2.getPath() + '/' + params[_this2.name + 'Id'] },
                'View'
              )
            ),
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                _reactRouter.Link,
                { to: _this2.getPath() + '/' + params[_this2.name + 'Id'] + '/edit' },
                'Edit'
              )
            ),
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                _reactRouter.Link,
                { to: _this2.getPath() + '/' + params[_this2.name + 'Id'] + '/delete' },
                'Delete'
              )
            )
          ),
          _react2.default.createElement(_reactRouter.Match, { pattern: _this2.getPath() + '/:' + _this2.name + 'Id', exactly: true, component: _this2.getView() }),
          _react2.default.createElement(_reactRouter.Match, { pattern: _this2.getPath() + '/:' + _this2.name + 'Id' + '/edit', exactly: true, component: _this2.getEdit() }),
          _react2.default.createElement(_reactRouter.Match, { pattern: _this2.getPath() + '/:' + _this2.name + 'Id' + '/delete', exactly: true, component: _this2.getDelete() })
        );
      },
      ...
      container: function container(_ref3) {
        ...
        if (isFetching) {
          ...
          return _react2.default.createElement(
            ...
            _react2.default.createElement(
              _reactRouter.Link,
              { className: 'btn btn-success', to: _this2.getPath() + 'Create' },
        ...
        return {
          ...
          onButtonClick: function onButtonClick(button, id) {
            switch (button) {
              case 'row':
              case 'view':
                router.transitionTo(_this2.getPath() + '/' + id);
                break;
              case 'edit':
                router.transitionTo(_this2.getPath() + '/' + id + '/edit');
                break;
              case 'delete':
                router.transitionTo(_this2.getPath() + '/' + id + '/delete');
                break;
            }
          }
        };
    ...
    return _this2.connectComponent({
      container: function container(_ref5) {
        ...
        if (form.isFetching || !form.form) {
          ...
          element = _react2.default.createElement(_Formio.Formio, { src: form.src, form: form.form, onFormSubmit: onFormSubmit });
        }
        return _react2.default.createElement(
          'div',
      ...
      mapDispatchToProps: function mapDispatchToProps(dispatch, ownProps, router) {
        ...
        return {
          onFormSubmit: function onFormSubmit(submission) {
            router.transitionTo(_this2.getPath() + '/' + submission._id);
          }
        };
      }
    });
    ...
    return _this2.connectComponent({
      container: function container(_ref15) {
        ...
        return _react2.default.createElement(
          ...
          _react2.default.createElement(_FormioConfirm.FormioConfirm, {
        ...
        return {
          onYes: function onYes() {
            _actions.SubmissionActions.delete(_this2.name, params[_this2.name + 'Id']).then(function () {
              router.transitionTo(_this2.getPath());
  ...
  this.getRoutes = function () {
    return _react2.default.createElement(
      ...
      _react2.default.createElement(_reactRouter.Match, { pattern: _this2.getPath(), exactly: true, component: _this2.getIndex() }),
      _react2.default.createElement(_reactRouter.Match, { pattern: _this2.getPath() + 'Create', exactly: true, component: _this2.getCreate() }),
      _react2.default.createElement(_reactRouter.Match, { pattern: _this2.getPath() + '/:' + _this2.name + 'Id', component: _this2.getContainer() })
    );
  };
};