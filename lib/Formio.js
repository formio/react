...
require('./Partials/FormComponents');
...
var Formio = exports.Formio = _react2.default.createClass({
  ...
  checkConditional: function checkConditional(component) {
    var subData = arguments.length <= 1 || arguments[1] === undefined ? {} : arguments[1];
    ...
    if (component.conditional && component.conditional.when) {
      ...
      try {
        ...
        var _data = _data; // eslint-disable-line no-unused-vars
  ...
  render: function render() {
    ...
    return _react2.default.createElement(
      ...
      loading,
      alerts,
      _react2.default.createElement(_FormioComponentsList.FormioComponentsList, {
