...
var FormioGrid = function (_React$Component) {
  ...
  function FormioGrid(props) {
    ...
    _this.formatCell = function (value, _ref) {
      ...
      var type = window.FormioComponents.hasOwnProperty(column.component.type) ? column.component.type : 'custom';
    ...
    _this.onRowClick = function (row) {
      return {
        onClick: function onClick() {
          if (!_this.props.buttons && typeof _this.props.onButtonClick === 'function') {
