...
var FormioGrid = function (_React$Component) {
  ...
  function FormioGrid(props) {
    ...
    _this.formatCell = function (value, _ref) {
      ...
      return _factories.FormioComponents.getComponent(column.component.type).prototype.getDisplay(column.component, value);
    };
    ...
    _this.componentWillReceiveProps = function (nextProps) {
      ...
      if (nextProps.pagination.page !== _this.state.pagination.page) {
        _this.setState(function (curState) {
          return curState.pagination.page = nextProps.pagination.page;
        });
      }
      if (nextProps.pagination.numPage !== _this.state.pagination.numPage) {
        _this.setState(function (curState) {
          return curState.pagination.numPage = nextProps.pagination.numPage;
        });
      }
      if (nextProps.pagination.size !== _this.state.pagination.size) {
        _this.setState(function (curState) {
          return curState.pagination.size = nextProps.pagination.size;
        });
      }
    };
    ...
    _this.loadSubmissions = function () {
      _this.formio.loadSubmissions({
        ...
        _this.setState(function (curState) {
          ...
          curState.pagination.numPages = Math.ceil(submissions.serverCount / _this.state.pagination.size);
          return curState;
        });
      });
    };
    ...
    _this.onPageChange = function (page) {
      if (typeof _this.props.onPageChange === 'function') {
        ...
        _this.setState(function (curState) {
          return curState.pagination.page = page;
        }, _this.loadSubmissions);
      }
    };

    _this.render = function () {
      var rows = resolve.resolve({
    ...
    _this.state = {
      ...
      pagination: _extends({}, FormioGrid.defaultProps.pagination, _this.props.pagination)
    };
    return _this;
  }
