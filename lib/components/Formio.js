...
var Formio = exports.Formio = _react2.default.createClass({
  ...
  onChange: function onChange(component, context) {
    ...
    this.validate();
    if (typeof this.props.onChange === 'function' && !component.state.isPristine) {
      this.props.onChange({ data: this.data }, component.props.component.key, component.state.value, _extends({}, context, { component: component }));
    }
