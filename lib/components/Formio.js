...
var Formio = exports.Formio = (0, _createReactClass2.default)({
  ...
  detachFromForm: function detachFromForm(component) {
    ...
    this.validate(function () {
      if (sendChange) {
        _this.externalChange(component);
      }
    });
  },
  ...
  externalChange: function externalChange(component, context) {
  ...
  onChange: function onChange(component) {
    ...
    this.validate(function () {
      _this2.externalChange(component, context);
    });
  ...
  clearHiddenData: function clearHiddenData(component) {
    ...
    if (!component.hasOwnProperty('clearOnHide') || component.clearOnHide !== false) {
      if (this.data.hasOwnProperty(component.key)) {
        ...
        this.externalChange({ props: { component: component }, state: { isPristine: true, value: null } });
      }
    }
  ...
  checkConditional: function checkConditional(component) {
    ...
    if (component.hasOwnProperty('hidden') && component.hidden) {
      ...
      show = _formioUtils2.default.checkCondition(component, row, this.data);
    }
  ...
  render: function render() {
    ...
    return _react2.default.createElement(
      'form',
      { role: 'form', name: 'formioForm', onSubmit: this.onSubmit, className: formClass },
      loading,
      alerts,
