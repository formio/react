...
exports.default = _react2.default.createClass({
  ...
  elementChange: function elementChange(row, component) {
    ...
    this.setState(function (previousState) {
      ...
      return _this8.props.onChange(component, { row: row, datagrid: _this8 });
    });
  },
  ...
  detachFromDatagrid: function detachFromDatagrid(row, component) {
    ...
    this.setState(function (previousState) {
      return Object.assign(previousState, _this10.validate());
    }, function () {
      _this10.props.onChange(_this10);
    });
  },
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          value.map(function (row, rowIndex) {
            return _react2.default.createElement(EditGridRow, _extends({}, _this11.props, {
              key: rowIndex,
              component: component,
              row: row,
              rowIndex: rowIndex,
              removeRow: _this11.removeRow,
              editRow: _this11.editRow,
              editDone: _this11.editDone,
