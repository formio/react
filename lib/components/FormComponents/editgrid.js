  ...
  function EditGridRow(props) {
    ...
    _this2.shouldComponentUpdate = function (nextProps) {
      var _this2$props = _this2.props,
          ...
          formPristine = _this2$props.formPristine;
...
exports.default = _react2.default.createClass({
  ...
  validateCustom: function validateCustom(value, state) {
    var isValid = true,
        errorType = '',
        errorMessage = '';
    var myState = state || this.state || { value: value, openRows: [] };
    if (myState) {
    ...
    var rowsValid = values.map(function (value) {
      ...
      if (component.validate && component.validate.row) {
        ...
        try {
          ...
          _valid = new Function('row', 'data', custom + '; return valid;')(row, data);
          state.isValid = _valid === true;
        } catch (e) {
  ...
  getElements: function getElements() {
    ...
    var Footer = renderTemplate(component.templates.footer, {
      components: component.components,
      util: _utils2.default,
      value: value
    });
    ...
    return _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        component.templates.header ? _react2.default.createElement(
          'li',
        ...
        _react2.default.createElement(
          'li',
          { className: 'editgrid-rows list-group-item' },
        ...
        component.templates.footer ? _react2.default.createElement(
          'li',
          { className: 'list-group-item list-group-footer' },
