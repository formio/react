...
module.exports = {
  getDefaultValue: function getDefaultValue(value) {
    ...
    if (value == null) {
      if (component.hasOwnProperty('customDefaultValue')) {
        try {
          var f = new Function('data', 'row', 'moment', 'var value = "";' + component.customDefaultValue.toString() + '; return value;');
          value = f(data, row, _moment2.default);
        } catch (e) {
  ...
  componentWillMount: function componentWillMount() {
    ...
    if (!(0, _util.deepEqual)(this.state.value, this.getEmptyValue()) || !this.props.options || !this.props.options.hasOwnProperty('skipInit') || !this.props.options.skipInit) {
