...
module.exports = {
  getDefaultValue: function getDefaultValue(value, props) {
  ...
  componentWillReceiveProps: function componentWillReceiveProps(nextProps) {
    ...
    if (component.hasOwnProperty('calculateValue') && component.calculateValue) {
      ...
      if (!(0, _util.deepEqual)(this.data, nextProps.data) || nextProps.row && !(0, _util.deepEqual)(this.row, nextProps.row)) {
        this.data = (0, _clone2.default)(nextProps.data);
        this.row = (0, _clone2.default)(nextProps.row);
    ...
    var defaultValue = this.getDefaultValue(value, nextProps);
