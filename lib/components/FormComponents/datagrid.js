...
var DataGridRow = function (_React$Component) {
  ...
  function DataGridRow() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = DataGridRow.__proto__ || Object.getPrototypeOf(DataGridRow)).call.apply(_ref, [this].concat(args))), _this), _this.shouldComponentUpdate = function (nextProps) {
      if (!(0, _lodash.isEqual)(_this.props.row, nextProps.row)) {
        return true;
      }
