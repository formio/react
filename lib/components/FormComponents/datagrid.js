  ...
  function DataGridRow(props) {
    ...
    _this.render = function () {
      var _this$props2 = _this.props,
          ...
          checkConditional = _this$props2.checkConditional,
          visibleCols = _this$props2.visibleCols;

      var datagridValue = _this.state && 'value' in _this.state ? _this.state.value : [];
      var btnClassNames = 'btn btn-default' + (_this.props.readOnly ? ' disabled' : '');
      ...
      return _react2.default.createElement(
        ...
        !component.hasOwnProperty('validate') || !component.validate.hasOwnProperty('minLength') || datagridValue.length > component.validate.minLength ? _react2.default.createElement(
          ...
          _react2.default.createElement(
            'a',
            { onClick: _this.props.removeRow.bind(null, rowIndex), className: btnClassNames },
...
module.exports = (0, _createReactClass2.default)({
  ...
  elementChange: function elementChange(row, component) {
    ...
    this.setState(function (previousState) {
      ...
      return _this4.props.onChange(component, { row: row, datagrid: _this4, item: _this4 });
    });
  },
  ...
  detachFromDatagrid: function detachFromDatagrid(row, component) {
    ...
    this.setState(function (previousState) {
      if (deleteKey && previousState.value[row]) {
        ...
        previousState.value = (0, _clone2.default)(previousState.value);
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          value.map(function (row, rowIndex) {
            return _react2.default.createElement(DataGridRow, _extends({}, _this7.props, {
