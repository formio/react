  ...
  function _class(props, context) {
    ...
    _this.componentWillMount = function () {
      if (typeof _this.initialize === 'function') {
        _this.initialize(_this.store, _this.props, _this.router);
      }
    };
    ...
    _this.componentWillReceiveProps = function (_ref) {
      ...
      if (!(0, _util.deepEqual)(params, _this.props.params) || location !== _this.props.location) {
        if (typeof _this.terminate === 'function') {
          _this.terminate(_this.store, _this.props, _this.router);
        }
        if (typeof _this.initialize === 'function') {
          _this.initialize(_this.store, _this.props, _this.router);
        }
    ...
    _this.render = function () {
      ...
      function () {
        ...
        if (typeof _this.mapDispatchToProps === 'function') {
