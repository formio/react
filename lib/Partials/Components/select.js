    ...
    switch (this.props.component.dataSrc) {
      ...
      case 'custom':
        this.refreshItems = function () {
          try {
            ...
            _this.setState({
              selectItems: eval('(function(data) { var values = [];' + _this.props.component.data.custom.toString() + '; return values; })(data)')
            });
          } catch (error) {
            _this.setState({
              selectItems: []
      ...
      case 'url':
        ...
        this.refreshItems = function (input, newUrl, append) {
          var data = Object.assign({}, _this.props.data, _this.props.subData);
