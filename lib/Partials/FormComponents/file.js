...
var fileSize = function fileSize(a, b, c, d, e) {
    ...
    return _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          'tr',
          null,
          _react2.default.createElement('th', { className: 'formio-dropzone-table' }),
          _react2.default.createElement(
            'th',
            null,
            'File Name'
  ...
  upload: function upload(files) {
    ...
    if (this.props.component.storage && files && files.length) {
      files.forEach(function (file) {
        ...
        _this.props.formio.uploadFile(_this.props.component.storage, file, fileName, dir, function (evt) {
          _this.setState(function (previousState) {
          ...
          _this.setValue(fileInfo, _this.state.value.length);
  ...
  getElements: function getElements() {
    ...
    return _react2.default.createElement(
      ...
      Object.keys(this.state.fileUploads).map(function (key) {
        return _this2.fileUpload(_this2.state.fileUploads[key], key);
      })
    );
  }
});