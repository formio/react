...
- 54c1bf9: FIO-10763 fixed Form Edit conflict resolution for react EFB
- 3566740: Prevents memory leak when the create form promise fulfills after the component is unmount
- 45f914d: Add existing patching mechanism for form edit conflict resolution.
- 88c609d: FIO-11245: fixed an issue where react builder does not work properly after react component redraw
- dd54c0a: Fix state bugs in EFB demo
- 99226bf: Fix a problem with form sync in the builder and eliminate browser caching on certain requests
...
- 690c856: update react form builder logic
- 3a67750: Fixes an issue where form tags are not diplayed in Form Edit
- 5dd15ee: Prevents memory leak when the create form promise fulfills after the component is unmount
- 02ba669: Fix a problem with form sync in the builder and eliminate browser caching on certain requests
...
- e5515fa: Fix an issue with a race condition between React and formio.js render cycles
